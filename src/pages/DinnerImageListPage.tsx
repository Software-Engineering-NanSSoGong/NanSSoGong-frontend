...
import { ClickableDinnerCard, PageNavigation, TitleWithLine } from '../components';
import { usePagination } from '../hooks';
import { dinnerNameState } from '../stores';
import { theme } from '../styles';

function DinnerImageListPage() {
...
export default DinnerImageListPage;
